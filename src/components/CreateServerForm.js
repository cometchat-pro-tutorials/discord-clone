...
const CreateServerForm = (props) => {
  ...
  const createServer = ({ id, name, description }) => {
    return { id, name, description, members: [user], nMembers: 1 };
  };
  ...
  const create = () => {
    const { name, description } = getInputs();
  ...
  return (
    <div className="s">
      <div className="s__content" style={{ paddingBottom: 0 }}>
        ...
        <div className="s__form">
          <div className="s__form-title">Server Name</div>
          <input type="text" ref={nameRef} />
          <div className="s__form-title">Server Description</div>
          <input type="text" ref={descriptionRef} />
          <p>By creating a server, you agree to Discord's <span className="highlight">Community Guidelines</span></p>
          <div className="s__fa">
            <div className="s__back" onClick={back}>
              <span>Back</span>
            </div>
            <div className="s__create" onClick={create}>
              <span>Create</span>
            </div>
          </div>
        </div>
