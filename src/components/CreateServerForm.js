...
const CreateServerForm = (props) => {
  ...
  return (
    <div className="cs">
      <div className="cs__content" style={{ paddingBottom: 0 }}>
        ...
        <div className="cs__subtitle">Customize your server</div>
        <p className="cs__description">Give your new server a personality with a name and an icon. You can always change it later.</p>
        <div className="cs__ui" onClick={() => file.current.click()}>
        ...
        <div className="cs__form">
          <div className="cs__form-title">Server Name</div>
          <input type="text" ref={nameRef} />
          <div className="cs__form-title">Server Description</div>
          <input type="text" ref={descriptionRef} />
          <p>By creating a server, you agree to Discord's <span className="highlight">Community Guidelines</span></p>
          <div className="cs__fa">
            <div className="cs__back" onClick={back}>
              <span>Back</span>
            </div>
            <div className="cs__create" onClick={create}>
              <span>Create</span>
            </div>
          </div>
        </div>
